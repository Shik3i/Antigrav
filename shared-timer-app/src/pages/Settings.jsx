...
import { getTimerToken, isLiveStreamWidgetVisible, setLiveStreamWidgetVisibility } from '../utils/clientStorage';
...
const Settings = ({ user, setUser, socket }) => {
    ...
    const handlePasswordChange = async (e) => {
        ...
        try {
            ...
            setPwdMessage(err.message || 'Error updating password');
        }
    };
    ...
    const toggleStreamWidget = (val) => {
        ...
        setLiveStreamWidgetVisibility(val);
