                    ...
                    <>
                        {loading ? (
                            ...
                            <div style={{ textAlign: 'center', padding: '40px' }} className="glass-card">
                                <Lightbulb size={32} color="#fbbf24" style={{ marginBottom: '16px', opacity: 0.75 }} />
                                <div style={{ fontSize: '1.05rem', color: 'var(--text-main)', marginBottom: '8px', fontWeight: 600 }}>
                                    {hasActiveFilters ? 'Nothing matches the current filter yet.' : 'No feature requests have been posted yet.'}
                                </div>
                                <p style={{ color: 'var(--text-muted)', margin: 0, lineHeight: 1.5 }}>
                                    {hasActiveFilters
                                        ? 'Try another status, switch between bugs and features, or reset the filter to browse the full roadmap.'
                                        : 'Be the first to suggest an improvement and help shape the next updates.'}
                                </p>
                            </div>
                        ) : (
